...
/**
 * CreateMediaTemplate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateMediaTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateMediaTemplate';
    ...
    */
    ...
    public function setComponents($components)
    {
        ...
        if ((count($components) < 0)) {
            throw new \InvalidArgumentException('invalid length for $components when calling CreateMediaTemplate., number of items must be greater than or equal to 0.');
        }
