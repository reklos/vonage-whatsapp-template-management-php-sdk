...
/**
 * ErrorResponse429 Class Doc Comment
 *
 * @category Class
 ...
 */
class ErrorResponse429 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ErrorResponse429';
    ...
    */
     ...
     * Sets type
     *
     * @param string|null $type URL for the documentation regarding the error.
     *
     * @return self
     */
     ...
     * Sets title
     *
     * @param string|null $title The title of the error.
     *
     * @return self
     */
     ...
     * Sets instance_id
     *
     * @param string|null $instance_id The instance ID for the request that generated the error.
     *
     * @return self
     */
