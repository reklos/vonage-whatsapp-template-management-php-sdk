 ...
 */
class UpdateTextTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateTextTemplate';
    ...
    */
    ...
    public function setComponents($components)
    {
        ...
        if ((count($components) < 0)) {
            throw new \InvalidArgumentException('invalid length for $components when calling UpdateTextTemplate., number of items must be greater than or equal to 0.');
        }
