<?php
/**
 * ListTemplates200ResponsePaging
 *
 * PHP version 7.4
 *
 * @category Class
 ...
 */
class ListTemplates200ResponsePaging implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListTemplates_200_response_paging';
    ...
    */
     ...
     * Sets next
     *
     * @param string|null $next A URI to ge the next paginated page.
     *
     * @return self
     */
     ...
     * Sets previous
     *
     * @param string|null $previous A URI to ge the previous paginated page.
     *
     * @return self
     */
