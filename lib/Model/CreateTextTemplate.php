...
/**
 * CreateTextTemplate Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateTextTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateTextTemplate';
    ...
    */
    ...
    public function setComponents($components)
    {
        ...
        if ((count($components) < 0)) {
            throw new \InvalidArgumentException('invalid length for $components when calling CreateTextTemplate., number of items must be greater than or equal to 0.');
        }
