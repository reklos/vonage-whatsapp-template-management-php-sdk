 ...
 */
class CreateTextTemplateComponentsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateTextTemplate_components_inner';
    ...
    */
     ...
     * Sets format
     *
     * @param string|null $format The format of the template component. For a Text Template, `format` is always `TEXT` for `HEADER`, `BODY` or `FOOTER` components.
     *
     * @return self
     */
