...
/**
 * CreateMediaTemplateComponentsInnerButtonsInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CreateMediaTemplateComponentsInnerButtonsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateMediaTemplate_components_inner_buttons_inner';
    ...
    */
     ...
     * Sets text
     *
     * @param string|null $text The text to appear on the button.
     *
     * @return self
     */
     ...
     * Sets otp_type
     *
     * @param string|null $otp_type The type of OTP button. Mandatory if the button `type` is `OTP`
     *
     * @return self
     */
     ...
     * Sets autofill_text
     *
     * @param string|null $autofill_text Mandatory if `otp_type` is `ONE_TAP`
     *
     * @return self
     */
     ...
     * Sets package_name
     *
     * @param string|null $package_name Your Android app's package name. Mandatory if `otp_type` is `ONE_TAP`
     *
     * @return self
     */
     ...
     * Sets signature_hash
     *
     * @param string|null $signature_hash Your app signing key hash. See [App Signing Key Hash](https://developers.facebook.com/docs/whatsapp/business-management-api/authentication-templates#app-signing-key-hash). Mandatory if `otp_type` is `ONE_TAP`
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url A URL to which the end-user will be directed when hitting the button. Must be set when `type` is `URL`.
     *
     * @return self
     */
     ...
     * Sets phone_number
     *
     * @param string|null $phone_number Phone number to which a phone call would be placed by the end-user when hitting the button. Must be set when `type` is `PHONE_NUMBER`.
     *
     * @return self
     */
